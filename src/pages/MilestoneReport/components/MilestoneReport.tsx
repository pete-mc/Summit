...
import { Column, ColumnDirective, ColumnsDirective, ContentType, ExcelExport, ExcelExportProperties, GridComponent, Inject, PageOrientation, PdfExport, PdfExportCompleteArgs, PdfPageSize, Sort, Toolbar } from '@syncfusion/ej2-react-grids'
...
export default class MilestoneReprtTable extends React.Component<MilestoneReportTableProps> {
  ...
  toolbarClick = (args: ClickEventArgs) => {
    if (this.grid && args.item.id === 'Grid_excelexport') { 
      let excelExportProperties = {
        ...
        columns: [{field: "name", headerText:'Name', width: 150 }, {field: "total_leads", headerText:'Leads', width: 120 }, {field: "total_assists", headerText:'Assists', width: 120  }, {field: "outdoors", headerText:'Outdoors', width: 120 }, {field: "creative", headerText:'Creative', width: 120 }, {field: "personalGrowth", headerText:'Personal Growth', width: 120 }, {field: "community", headerText:'Community', width: 120 } ] as Column[],
    ...
    if (this.grid && args.item.id === 'Grid_pdfexport') {
      const PdfExportProperties = {
        ...
        columns: [{field: "name", headerText:'Name', width: 140 }, {field: "total_leads", headerText:'Leads', width: 90 }, {field: "total_assists", headerText:'Assists', width: 90  }, {field: "outdoors", headerText:'Outdoors', width: 90 }, {field: "creative", headerText:'Creative', width: 90 }, {field: "personalGrowth", headerText:'Personal Growth', width: 90 }, {field: "community", headerText:'Community', width: 90 } ] as Column[],
        header: {
          fromTop: 0,
          height: 60,
          contents: [
  ...
  render(): React.ReactNode {
    return (
      <GridComponent id="Grid" dataSource={this.props.items} allowSorting={true} toolbar={['Print', 'PdfExport', 'ExcelExport']} allowPdfExport={true} allowExcelExport={true} toolbarClick={this.toolbarClick} ref={(g: GridComponent | null) => this.grid = g}>
        <ColumnsDirective>

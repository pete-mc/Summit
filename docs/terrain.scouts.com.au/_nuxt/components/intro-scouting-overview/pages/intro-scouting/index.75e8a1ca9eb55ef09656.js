    ...
    [20, 56, 82], {
        ...
        1324: function(e, t, o) {
            ...
            var r = o(40),
                ...
                v = o(908),
                c = r.A.extend({
                    name: "IntroScoutingOverview",
                    data: () => ({
                        INTRO_SCOUTING_IMAGE_NAMES: v.c,
                        PATH: n
                    })
                }),
                l = o(9),
                component = Object(l.a)(c, (function() {
                    ...
                    return t("BaseOverview", {
                        attrs: {
                            ...
                            "image-path": e.INTRO_SCOUTING_IMAGE_NAMES.overview + ".svg",
                            "button-title": e.isYouthMember ? "Start my Scouting journey" : "View requirements",
                            "create-function": e.newAchievement,
                            "has-existing-submissions": e.hasExistingSubmissionsForSection(),
                            "has-awarded": e.hasAwarded()
                        }
                        ...
                        attrs: {
                            ...
                            "image-src": e.fetchImage(e.INTRO_SCOUTING_IMAGE_NAMES.side)
                        }
                    })], 1), e._v(" "), t("template", {

    ...
    [26, 54, 55, 56, 58, 82, 85, 88, 142], {
        ...
        1336: function(e, t, o) {
            ...
            var r = o(1),
                ...
                component = Object(c.a)(v, (function() {
                    ...
                    return e("BaseSubDescription", [e("p", [this._v("\n    For the Peak Award, you may choose to attend an internal Scouting course run for the Scout section, a state or\n    national extension course such as You+Lead or an external personal development course such as school leadership\n    courses.\n  ")]), this._v(" "), e("p", [this._v("This course should be a weekend in length for the Scout section.")]), this._v(" "), e("p", [this._v("\n    The leadership or personal development course allows you to put into practice some of the skills you have learned\n    during your time in the section. The purpose is to support you in the development of personal and leadership\n    skills.\n  ")]), this._v(" "), e("p", [this._v("\n    Your state/Branch of Scouts Australia should be able to support you in finding a course that suits your needs.\n  ")])])
                }), [], !1, null, null, null);
            t.default = component.exports;
            installComponents(component, {
                BaseSubDescription: o(991).default
            })
        },
        1384: function(e, t, o) {
            "use strict";
        ...
        1421: function(e, t, o) {
            ...
            var r = o(870),
                ...
                y = o(962),
                k = n.u.extend({
                    name: "PersonalDevelopmentOverview",
                    components: {
                        AchievementOverview: f.default,
                        BaseOverview: m.default,
                        BaseOverviewSubDescription: _.default,
                        ConfirmationDialog: w.default,
                        InfoDialogCard: y.default,
                        PersonalDevelopmentSubDescription: h.default
                    },
                    data: () => ({
                        PATH: l,
                        ICON: c,
                        PERSONAL_DEVELOPMENT_IMAGE_NAMES: d.h,
                        NAV_LABEL: v.l,
                        deleteModal: !1,
                        developmentToDelete: {}
                    }),
                    ...
                    computed: {
                        isReady() {
                            return void 0 !== this.$accessor.personalDevelopment.getTemplate.document
                        },
                        canStartReview() {
                            return this.manager.getList().length < 2
                        },
                        canShowImage() {
                            return !this.hasExistingSubmissionsForSection()
                        }
                    },
                    methods: {
                        confirmDelete(e) {
                            this.deleteModal = !0, this.developmentToDelete = e
                        },
                        deleteDevelopment() {
                            this.deleteModal = !1, this.deleteAchievement(this.developmentToDelete.id)
                        },
                        getDevelopmentTitle: () => "" + v.l.PERSONAL_DEV_UNIT_MANAGEMENT,
                        closeDialog() {
                            this.deleteModal = !1
                        },
                        fetchImage: image => o(917)(`./${image}.svg`)
                    }
                }),
                S = (o(1384), o(9)),
                component = Object(S.a)(k, (function() {
                    var e = this,
                        t = e._self._c;
                    e._self._setupProxy;
                    return e.isReady ? t("div", {
                        staticClass: "PersonalDevelopmentOverview"
                    }, [t("BaseOverview", {
                        attrs: {
                            ...
                            "pd-can-review": e.canStartReview,
                            "is-pd": "",
                            "create-fab": ""
                        }
                    }, [t("template", {
                        ...
                        attrs: {
                            items: e.$accessor.personalDevelopment.getList,
                            "title-func": e.getDevelopmentTitle,
                        ...
                        slot: "new-achievement"
                    }, [!e.canShowImage && e.canStartReview ? t("div", {
                        staticClass: "mt-12"
                    }, [t("p", [e._v("If you are attending a second course, please submit another review.")])]) : e._e(), e._v(" "), e.canStartReview ? t("div", {
                        staticClass: "PersonalDevelopment"
                    }, [e.isYouthMember ? [t("div", {
                        staticClass: "PersonalDevelopment__description-title mt-4 mb-2"
                    }, [e._v("Review")]), e._v(" "), e.canShowImage ? t("VueShowdown", {
                        staticClass: "VueShowdown VueShowdown--base-overview",
                        attrs: {
                            markdown: e.emptyState
                        }
                    }) : e._e()] : e._e(), e._v(" "), !e.isYouthMember && e.$vuetify.breakpoint.mdAndUp ? t(r.a, {
                        staticClass: "PersonalDevelopment__create-button",
                        attrs: {
                    ...
                    }, [e._v("\n              View requirements\n            ")]) : e._e(), e._v(" "), e.isYouthMember && e.profileSectionEqualsAppSection && e.$vuetify.breakpoint.mdAndUp ? t(r.a, {
                        staticClass: "PersonalDevelopment__create-button",
                        attrs: {
                            rounded: "",
                            small: "",
                    ...
                    }, [e._v("\n              Start Review\n            ")]) : e._e(), e._v(" "), e.canShowImage ? t("img", {
                        staticClass: "mt-12",
                        attrs: {
                            src: e.fetchImage(e.PERSONAL_DEVELOPMENT_IMAGE_NAMES.overview),
                            alt: "personal-development-overview"
                        }
                    }) : e._e()], 2) : e._e()])], 2)], 1), e._v(" "), t("template", {
                        slot: "sub-description-side"
                    }, [t("BaseOverviewSubDescription", {
                        attrs: {
                            text: e.subDescription,
                            links: e.subDescriptionLinks,
                            "image-src": e.fetchImage(e.PERSONAL_DEVELOPMENT_IMAGE_NAMES.side)
                        }
                    })], 1), e._v(" "), t("template", {
                        ...
                        attrs: {
                            ...
                            links: e.subDescriptionLinks,
                            "image-src": e.fetchImage(e.PERSONAL_DEVELOPMENT_IMAGE_NAMES.side),
                            "image-alt": "Personal Development"
                        }
                    }) : e._e()], 1)], 2), e._v(" "), t("ConfirmationDialog", {
                        attrs: {
                            model: e.deleteModal,
                            title: "Delete Reflection?",
                            subtitle: "You will not be able to edit or submit this personal development after it has been deleted.",
                            "confirm-button-label": "DELETE",
                            "confirm-callback": e.deleteDevelopment,
                            "close-dialog": e.closeDialog
                        }
                    })], 1) : e._e()
                }), [], !1, null, "23b2fe0f", null);
            t.default = component.exports;
            installComponents(component, {
        ...
        917: function(e, t, o) {
            ...
            }, r.resolve = n, e.exports = r, r.id = 917
        },
        954: function(e, t, o) {
            e.exports = {}
        },
